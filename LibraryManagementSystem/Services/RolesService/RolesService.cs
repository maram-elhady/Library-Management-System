...
namespace LibraryManagementSystem.Services.AuthService
{
    public class RolesService : IRolesService
    {
        ...
        public RolesService(UserManager<ApplicationUser> userManager, IOptions<JWT> jwt, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<string> AddRoleAsync(AddRoleDto model)
        {
            ...
            // Remove default "Member" role before assigning new role
